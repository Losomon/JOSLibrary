...
const Icons = {
  ...
  Children: () => (
    <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
      ...
      <path d="M5 22v-5a5 5 0 0 1 5-5h4a5 5 0 0 1 5 5v5" />
    </svg>
  ),
  Business: () => (
    <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
...
export default function PublicDashboard() {
  ...
  return (
    <div className="public-dashboard">
      ...
      {/* Hero Section */}
      <div className="hero">
        <div className="h-eye">✦ Bibliotheca · Kutus, Kirinyaga County</div>
        <h1 className="h-title">Discover your next<br /><em>great read.</em></h1>
        <p className="h-sub">Borrow free, reserve titles, or purchase your favourites. 84,000+ books — for every reader.</p>
